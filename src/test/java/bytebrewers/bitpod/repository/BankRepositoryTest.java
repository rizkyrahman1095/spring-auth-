...
class BankRepositoryTest {
    ...
    @Test
    public void givenBankObject_whenBankFindByName_thenReturnBank() {
        bankRepository.findByName(String.valueOf(bank));
        assertNotNull(bankRepository.findByName(bank.getName()));
    }
